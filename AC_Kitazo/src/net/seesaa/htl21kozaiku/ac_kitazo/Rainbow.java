...
/**
 * Helper class for showing and canceling rainbow notifications.
 * <p>
...
public class Rainbow {
	 ...
	 */
	private static final String NOTIFICATION_TAG = "Rainbow";
	 ...
	 * presentation of rainbow notifications. Make sure to follow the <a
	...
	public static void notify(final Context context,
		...
		final String title = res.getString(
				R.string.rainbow_notification_title_template, exampleString);
		final String text = res.getString(
				R.string.rainbow_notification_placeholder_text_template,
				exampleString);
		...
		final NotificationCompat.Builder builder = new NotificationCompat.Builder(
				...
				.setSmallIcon(R.drawable.ic_stat_rainbow)
